const getEpiParams = model_run => {
  ...
  eP.gamma_0 = 0
  eP.gamma_1 =
    (1 / model_run.duration_mild_infections) *
    (1 - model_run.hospitalization_rate)

  eP.rho_0 = 0
  eP.rho_1 = 1 / model_run.duration_mild_infections - eP.gamma_1
  eP.rho_2 =
    (1 / model_run.hospital_time_recovery) *
    (eP.fraction_critical / model_run.hospitalization_rate)

  eP.gamma_2 = 1 / model_run.hospital_time_recovery - eP.rho_2

  eP.mu =
    (1 / model_run.icu_time_death) *
    (model_run.case_fatality_rate / eP.fraction_critical)

  eP.gamma_3 = 1 / model_run.icu_time_death - eP.mu

  eP.gamma_A = 1 / model_run.duration_asymp_infections

  eP.gamma = [eP.gamma_0, eP.gamma_1, eP.gamma_2, eP.gamma_3, eP.gamma_A]

  // "gamma": L(gamma_0, gamma_1, gamma_2, gamma_3, A = 0),
  eP.rho = [eP.rho_0, eP.rho_1, eP.rho_2]
  ...
  eP.serial_interval =
    model_run.presymptomatic_period + model_run.duration_mild_infections / 2
